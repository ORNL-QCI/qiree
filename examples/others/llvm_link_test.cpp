...
int main()
{
    ...
    llvm::Function* func = llvm::Function::Create(
        funcType, llvm::Function::ExternalLinkage, "my_function", module.get());

    llvm::BasicBlock* entry = llvm::BasicBlock::Create(context, "entry", func);
    llvm::IRBuilder<> builder(entry);

    // Declare the external function
    llvm::FunctionType* externalFuncType
        = llvm::FunctionType::get(llvm::Type::getVoidTy(context), false);
    llvm::Function* externalFunc
        = llvm::Function::Create(externalFuncType,
    ...
    engine->addGlobalMapping(externalFunc,
                             reinterpret_cast<void*>(external_function));
