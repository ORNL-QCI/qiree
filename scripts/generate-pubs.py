...
These publications are extracted from the QIR-EE team's Zotero database.""", file=out)
    ...
    print_subheader("Preprint articles")
    for e in get_collection_items("Preprints"):
        print("-", format_paper(e), file=out)
...
These publications are extracted from the QIR-EE team's Zotero database.""", file=out)
    ...
    for e in get_collection_items("References"):
        print("-",format_paper(e), file=out)
