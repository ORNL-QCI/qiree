...
entry:
  ...
  call void @__quantum__qis__rx__body(double 0x3FE0C152382D7365, %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__ry__body(double 1.047000e+00, %Qubit* inttoptr (i64 2 to %Qubit*))
  call void @__quantum__qis__rz__body(double 1.571000e+00, %Qubit* inttoptr (i64 3 to %Qubit*))
